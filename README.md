...
```
git clone https://gitflic.ru/project/pereverzevivan/biznes-processy-1-laba.git
cd biznes-processy-1-laba
...
cd existing_folder
git init
git remote add origin https://gitflic.ru/project/pereverzevivan/biznes-processy-1-laba.git
git clone
